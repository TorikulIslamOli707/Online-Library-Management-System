...
<head>
    ...
    <script src="issuebookcheck.js"></script>
</head>
<body>
<div >
...
<section>
        ...
        <div class="box1">
            <div class="formbx">
                <h2>ISSUE BOOKS</h2>
                <form action="phpConnection/issuedate.php" onSubmit="return issuebookinputcheck();" method="POST">
                <div class="inputBx">
                    ...
                    <div class="inputBx">
                        ...
                        <p style="color:red" id="sdate_error" ></p>
                    </div>
                    <div class="inputBx">
                        <span>Return Date</span>
                        <input type="date" name="rdate" id="rdate" >
                        <p style="color:red" id="rdate_error" ></p>
                    </div>
